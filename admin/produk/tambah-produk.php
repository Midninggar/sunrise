        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!empty($gambar)){
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    ...
                    $sql="insert into produk (kode_produk,judul_produk,harga,deskripsi,gambar,tanggal,status,id_kategori) values
                    ('$kode_produk','$judul_produk','$harga','$deskripsi','$gambar','$tanggal','$status','$kategori')";
                }    
            ...
            if ($simpan_produk) {
                header("Location:../index.php?halaman=produk&kategori=$kategori&add=berhasil");
            }
            else {
                header("Location:../index.php?halaman=produk&kategori=$kategori&add=gagal");
...
?>
<form action="produk/tambah-produk.php" method="post" enctype="multipart/form-data">
    <!-- rows -->
    <div class="row">
        <div class="col-sm-12">
